...
{ 
	 ...
	 if(isset($_POST["update"]))
	{
	    ...
	    $result=mysql_query($sql);
	    header("Location: http://localhost/manoj/Online_Shopping_Cart/customerProfile.php");
	}
	...
	$(document).ready(function(){		
		...
		<body onload="fun1()">
			...
			<div id="div1"></div>
			<div id="div2" style="position:absolute; top:35%; left:35%;"><img src="css/cb.png" style="float:right; width:30px; cursor:pointer" onClick="funcloseDiv2(); location='customerProfile.php';">
			<br>
